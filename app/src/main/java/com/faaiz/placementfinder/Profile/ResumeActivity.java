...
public class ResumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isEmployer = getIntent().getBooleanExtra("isEmployer", false);
        isAccepted = getIntent().getBooleanExtra("isAccepted", false);
        userId = "";
        jobId = "";
        if(isEmployer){
            user = (User) getIntent().getSerializableExtra("user");
            LinearLayout ll = findViewById(R.id.actionBtn);
            ll.setVisibility(View.VISIBLE);
            userId = getIntent().getStringExtra("userId");
            jobId = getIntent().getStringExtra("jobId");
            if(isAccepted){
                LinearLayout ll2 = findViewById(R.id.implicitIntent);
...
// Add similar blocks for languages, education, projects, and experience
        ...
        rejectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showProgressDialog("Rejecting Job Application...");
        ...
        acceptBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isAccepted){
                    Toast.makeText(ResumeActivity.this, "Already accepted this Job Application", Toast.LENGTH_SHORT).show();
                }else{
                    showProgressDialog("Accepting Job Application...");
                    acceptJobApplication();
                }
            }
        });

        LinearLayout emailOption = findViewById(R.id.emailOption);
        LinearLayout callOption = findViewById(R.id.callOption);
        ...
        emailOption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{user.getEmail().trim()});
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Application Accepted");
        ...
        callOption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callIntent.setData(Uri.parse("tel:+91" + user.getMobile())); // Set the phone number here
...
// Update the value corresponding to the user ID under the specified job ID to true
        applicationsRef.child(userId).setValue(true).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                // Value updated successfully
                Log.d("TAG", "Value updated successfully");
                progressDialog.dismiss();
                Toast.makeText(ResumeActivity.this, "Job Application Accepted", Toast.LENGTH_SHORT).show();
                LinearLayout ll = findViewById(R.id.implicitIntent);
                ll.setVisibility(View.VISIBLE);
                isAccepted = true;
            }
...
// Remove the user ID under the specified job ID
        applicationsRef.child(userId).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                // User ID deleted successfully
                progressDialog.dismiss();
                Toast.makeText(ResumeActivity.this, "Application Rejected", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(ResumeActivity.this, EmployerApplicationsActivity.class);
